...
using namespace std;
	...
	void UserInterface::menu(stack<Directory> &directories, DiskManager &diskManager) {
	...
	called by: main
	*/
	void UserInterface::createFileName(DiskManager &dm) {
	...
	*/
	...
	int UserInterface::checkExtension(std::string fileName) {
	...
	*/
	...
	bool UserInterface::checkString(std::string fileName) {
	...
	*/
	...
	string UserInterface::namePadder(string name) {
	...
	*/
	void UserInterface::createTextFile(string name,DiskManager &dm) {
		string contents;
		cout << "Enter Text: ";
		cin.ignore();
	...
	*/
	void UserInterface::createProgramFile(string name, DiskManager &dm ) {
		int cpuReq;
		int memReq;
	...
	*/
	string UserInterface::createDirName() {
	...
	*/
	...
	Directory UserInterface::createDirectory( DiskManager &dm) {
